        ...
        $('.reorder_link').on('click',function(){
          ...
          $("#save_reorder").click(function( e ){
            if( !$("#save_reorder i").length ){
              ...
              $("#reorder-helper").html( "Ordenando categorias - Esto podría tomar un momento. Por favor, espere..." ).removeClass('light_box').addClass('notice notice_error');
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="btns-top">
            <a href="crear-nueva-categoria.php" class="btn btn-info"><i class="fa  fa-plus-square"></i> Crear nueva categoría</a>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <td class="text-center"><a href=<?php echo "'edit-categoria.php?id=".$categoria_id."'";?>><i class="fa fa-edit"></i></a></td>
                  <td class="text-center"><a href="#" data-toggle="modal" data-target=<?php echo "'#deleteModal".$categoria_id."'";?>><i class="fa fa-remove"></i></a></td>
                      <form class="form" action="delete-categoria.php" method="POST">
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <p>Vas a eliminar la categoria #<?php echo $categoria_nombre;?></p>
      ...
      <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  <div style="margin-top:0px;">
                    <a href="javascript:void(0);" class="btn outlined mleft_no reorder_link" id="save_reorder">Ordenar Categorias</a>
                      ...
                      <div class="gallery">
                        ...
                        $categorias = $db2->getCategorias();
                        if(!empty($categorias)){
                          foreach($categorias as $cat){
                              $cat_id = $cat['categoria_id'];
                              $imagenes_nombre = $cat['categoria_imagen'];
                              
                              
                        ?>
                              <li id="image_li_<?php echo $cat['categoria_id']; ?>" class="ui-sortable-handle">
                                <a href="javascript:void(0);" style="float:none; width: 10px;" class="image_link"><img src="../images_admin/categorias/<?php echo $imagenes_nombre; ?>" alt=""></a>
                              </li>
                          <?php } } ?>
                          </ul>
                      </div>
